...
Clang: clang version 6.0 r329799 (http://llvm.org/viewvc/llvm-project/cfe?view=revision&revision=329799)<br>
LLVM:  LLVM  version 6.0 r330209 (http://llvm.org/viewvc/llvm-project?view=revision&revision=330209)<br>
Compiler-rt: r324506              (http://llvm.org/viewvc/llvm-project/compiler-rt?view=revision&revision=324506)<br>
...
* LLVM: yes
* GCC: no
* Bugs/ML: <https://reviews.llvm.org/rL318038><br>
...
* LLVM: yes
* GCC: no
* Bugs/ML: <https://reviews.llvm.org/rL318666><br>
